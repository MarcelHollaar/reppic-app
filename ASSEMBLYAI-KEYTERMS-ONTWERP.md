# AssemblyAI: keyterms + Universal-3 Pro — ontwerp & testplan
...
`keyterms_prompt` op het nieuwere **Universal-3 Pro**-model. Per gesprek
...
- capt op bijv. **400** termen om relevantie te bewaren (harde limiet is 1.000 op Universal-3 Pro)
...
- `word_boost` **niet** gebruiken — afgeschaft en geweigerd door Universal-3 Pro;
...
2. Transcribeer elke opname in **3 configuraties** via het testscript:
   ...
   - **B. Universal-3 Pro** — alleen `speech_model`, geen keyterms
   - **C. Universal-3 Pro + keyterms** — basis + bedrijfsnaam + glossary + producten
