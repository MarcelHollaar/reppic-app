...
const KEY = PLATFORM_SETTING_KEYS.LMS_PATHGEN_LITELLM_MODEL;

/** GET — instellingen voor de AI-leerpadgeneratie-modelpicker (superadmin). */
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("[platform-settings/lms-pathgen-model] GET failed:", error);
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    console.error("[platform-settings/lms-pathgen-model] PUT failed:", error);
    const status =
