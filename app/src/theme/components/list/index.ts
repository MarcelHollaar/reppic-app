    ...
    base: {
      ...
      item: {
        initial: {
          ...
          bg: "hover:tw-bg-blue-50 active:tw-bg-blue-gray-50 active:tw-bg-opacity-80",
          color:
            "hover:tw-text-black focus:tw-text-blue-gray-900 active:tw-text-blue-gray-900",
